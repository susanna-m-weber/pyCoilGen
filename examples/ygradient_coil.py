...
if __name__ == '__main__':
    ...
    arg_dict = {
        'field_shape_function': '50',            # % definition of the target field ['x']
        ...
        'interconnection_cut_width': 0.05,       # Width cut used when cutting and joining wire paths; in metres [0.01]
        ...
        'tikhonov_reg_factor': 10,             # Tikhonov regularization factor for the SF optimization [1]
